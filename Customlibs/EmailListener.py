...
class EmailListener:
    ...
    def close(self):
        ...
        self.total_time = (
                    datetime.datetime.strptime(self.end_time, '%H:%M:%S') - datetime.datetime.strptime(self.start_time,
                                                                                                       '%H:%M:%S'))
...
def send_email(send_email, subject, smtp, from_user, pwd, to, cc, total, passed, failed, percentage, exe_date,
               elapsed_time, company_name):
    if send_email:
        ...
        dir_path = "/Users/cdhingra/PycharmProjects/DNS_Testing/Production_Logs"
        logfile = ["Ipsec_workflow_log.html", "Ipsec_workflow_Report.html"]
        ...
        <body>
            <div class="rf-box">
                ...
                <p style="padding-left:20px">
                    Hi Team,<br>
                    Following are the last build execution result. Please refer the above metrics for more information.<br>
                </p>
        ...
        """ % (company_name, total, passed, failed, percentage, exe_date)

        msg.attach(MIMEText(email_content, 'html'))

        for f in logfile:  # add files to the message
